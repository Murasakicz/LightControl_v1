...
String MQTT::constructChanelString(uint8_t chanelId){
  String tmp = _deviceName;
         tmp += "/";

  switch(chanelId){
    case 0:
      tmp += _config.channel0Id;
    break;
    case 1:
      tmp += _config.channel1Id;
    break;
    case 2:
      tmp += _config.channel2Id;
    break;
    case 3:
      tmp += _config.channel3Id;
    break;
  }
...
/*#ifndef RELEASE
    ...
    _config.channel0Id = json["channel0Id"].as<const char *>();
    _config.channel1Id = json["channel1Id"].as<const char *>();
    _config.channel2Id = json["channel2Id"].as<const char *>();
    _config.channel3Id = json["channel3Id"].as<const char *>();
